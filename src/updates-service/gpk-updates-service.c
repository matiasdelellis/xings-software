...
main (int argc, char *argv[])
{
	...
	notify_init (_("Package Updates Service"));

	/* TRANSLATORS: program name, a session wide daemon to watch for updates */
	g_set_application_name (_("Package Update Service"));
	context = g_option_context_new (NULL);
	g_option_context_set_summary (context, _("Package Update Service with PackageKit"));
