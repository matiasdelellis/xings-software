...
static const PkEnumMatch enum_info_icon_name[] = {
	...
	{PK_INFO_ENUM_INSTALLED,		"xings-package-installed"},
	{PK_INFO_ENUM_AVAILABLE,		"xings-package-available"},
	{PK_INFO_ENUM_LOW,			"xings-update-low"},
	{PK_INFO_ENUM_NORMAL,			"xings-update-normal"},
	{PK_INFO_ENUM_IMPORTANT,		"xings-update-high"},
	{PK_INFO_ENUM_SECURITY,			"xings-update-security"},
	...
	{PK_INFO_ENUM_REMOVING,			"xings-package-delete"},
	{PK_INFO_ENUM_OBSOLETING,		"xings-package-cleanup"},
	{PK_INFO_ENUM_CLEANUP,			"xings-package-cleanup"},
	{PK_INFO_ENUM_COLLECTION_INSTALLED,	"xings-collection-installed"},
	{PK_INFO_ENUM_COLLECTION_AVAILABLE,	"xings-collection-available"},
	{PK_INFO_ENUM_FINISHED,			"dialog-information"},
	{PK_INFO_ENUM_REINSTALLING,		"dialog-information"},
	{PK_INFO_ENUM_DOWNGRADING,		"xings-package-update"},
...
static const PkEnumMatch enum_status_icon_name[] = {
	...
	{PK_STATUS_ENUM_DOWNLOAD_GROUP,		"xings-refresh-cache"},
	{PK_STATUS_ENUM_DOWNLOAD_PACKAGELIST,	"xings-refresh-cache"},
	{PK_STATUS_ENUM_DOWNLOAD,		"xings-package-download"},
	{PK_STATUS_ENUM_DOWNLOAD_REPOSITORY,	"xings-refresh-cache"},
	{PK_STATUS_ENUM_DOWNLOAD_UPDATEINFO,	"xings-refresh-cache"},
	{PK_STATUS_ENUM_FINISHED,		"xings-package-cleanup"}, /* TODO: need better icon */
	{PK_STATUS_ENUM_GENERATE_PACKAGE_LIST,	"xings-refresh-cache"}, /* TODO: need better icon */
	{PK_STATUS_ENUM_WAITING_FOR_LOCK,	"xings-package-blocked"},
	{PK_STATUS_ENUM_WAITING_FOR_AUTH,	"gtk-dialog-authentication"},
	{PK_STATUS_ENUM_INFO,			"xings-package-info"},
	{PK_STATUS_ENUM_INSTALL,		"xings-package-add"},
	{PK_STATUS_ENUM_LOADING_CACHE,		"xings-refresh-cache"},
	{PK_STATUS_ENUM_OBSOLETE,		"xings-package-cleanup"},
	{PK_STATUS_ENUM_QUERY,			"xings-package-search"},
	{PK_STATUS_ENUM_REFRESH_CACHE,		"xings-refresh-cache"},
...
static const PkEnumMatch enum_role_icon_name[] = {
	...
	{PK_ROLE_ENUM_DEPENDS_ON,		"xings-package-info"},
	{PK_ROLE_ENUM_DOWNLOAD_PACKAGES,	"xings-package-download"},
	{PK_ROLE_ENUM_GET_CATEGORIES,		"xings-package-info"},
	{PK_ROLE_ENUM_GET_DETAILS,		"xings-package-info"},
	{PK_ROLE_ENUM_GET_DETAILS_LOCAL,	"xings-package-search"},
	{PK_ROLE_ENUM_GET_DISTRO_UPGRADES,	"xings-package-info"},
	{PK_ROLE_ENUM_GET_FILES,		"xings-package-search"},
	{PK_ROLE_ENUM_GET_FILES_LOCAL,		"xings-package-search"},
	{PK_ROLE_ENUM_GET_OLD_TRANSACTIONS,	"xings-package-info"},
	{PK_ROLE_ENUM_GET_PACKAGES,		"xings-package-search"},
	{PK_ROLE_ENUM_GET_REPO_LIST,		"xings-package-sources"},
	{PK_ROLE_ENUM_GET_UPDATE_DETAIL,	"xings-package-info"},
	{PK_ROLE_ENUM_GET_UPDATES,		"xings-package-info"},
	{PK_ROLE_ENUM_INSTALL_FILES,		"xings-package-add"},
	{PK_ROLE_ENUM_INSTALL_PACKAGES,		"xings-package-add"},
	{PK_ROLE_ENUM_INSTALL_SIGNATURE,	"emblem-system"},
	{PK_ROLE_ENUM_REFRESH_CACHE,		"xings-refresh-cache"},
	{PK_ROLE_ENUM_REMOVE_PACKAGES,		"xings-package-delete"},
	{PK_ROLE_ENUM_REPO_ENABLE,		"xings-package-sources"},
	{PK_ROLE_ENUM_REPO_SET_DATA,		"xings-package-sources"},
	{PK_ROLE_ENUM_REPO_REMOVE,		"xings-package-sources"},
	{PK_ROLE_ENUM_REQUIRED_BY,		"xings-package-info"},
	{PK_ROLE_ENUM_RESOLVE,			"xings-package-search"},
	{PK_ROLE_ENUM_SEARCH_DETAILS,		"xings-package-search"},
	{PK_ROLE_ENUM_SEARCH_FILE,		"xings-package-search"},
	{PK_ROLE_ENUM_SEARCH_GROUP,		"xings-package-search"},
	{PK_ROLE_ENUM_SEARCH_NAME,		"xings-package-search"},
...
gpk_info_status_enum_to_icon_name (GpkInfoStatusEnum info)
{
	...
	if (info == GPK_INFO_ENUM_DOWNLOADED)
		return "xings-package-downloaded";
	if (info == GPK_INFO_ENUM_INSTALLED ||
	    info == GPK_INFO_ENUM_UPDATED)
		return "xings-package-installed";
